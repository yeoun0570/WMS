...
public interface OutboundRepository extends JpaRepository<Outbound, Long> {
    ...
    @Query("SELECT new lcw.lcw2_back.dto.OutboundDTO(o.outboundPK.outboundId, p.productName, s_from.storageName, o.requestQuantity, o.status, o.requestDate, s_to.storageName) " +
            "FROM Outbound o " +
            "JOIN o.userId u " +
